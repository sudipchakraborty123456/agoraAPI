...
var appID = "cd2d570b14e543cd96404622fa2bd8c7";
var appCertificate = "6a5580072932463fbea5b9cf49353507";
...
console.log(uid);
    var key = RtcTokenBuilder.buildTokenWithUid(appID, appCertificate, channelName, uid, "publisher", privilegeExpiredTs);

    resp.header("Access-Control-Allow-Origin", "*")
        //resp.header("Access-Control-Allow-Origin", "http://ip:port")
    return resp.json( key ).send();
};
